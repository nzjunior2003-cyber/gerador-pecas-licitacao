        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-6 w-full max-w-2xl transform transition-all">
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200">Assistente IA para "{fieldName}"</h2>
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="ai-prompt" className="block text-gray-700 dark:text-gray-300 font-semibold mb-2">Descreva sua ideia:</label>
                <input
                  id="ai-prompt"
                  type="text"
                  value={prompt}
                  ...
                  className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-cbmpa-blue-end dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 dark:placeholder-gray-400"
                  disabled={isLoading}
                />
              </div>
              ...
              {generatedText && (
                <div className="mt-4 p-4 border rounded-md bg-gray-50 dark:bg-gray-700 dark:border-gray-600 max-h-60 overflow-y-auto">
                    <h3 className="font-bold mb-2 dark:text-gray-200">Texto Sugerido:</h3>
            ...
            <div className="mt-6 flex justify-end gap-4">
                <button onClick={closeModal} className="bg-gray-200 hover:bg-gray-300 text-gray-800 dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-gray-200 font-bold py-2 px-4 rounded-lg">Cancelar</button>
